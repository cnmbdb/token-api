(() => {
  ...
  const dictionaries = {
    'zh-CN': {
      ...
      nav: ['主页', '控制台', '模型广场', '排行榜', '文档', '群聊', '邀请返现'],
      pill: '全球模型直连 · 低至 1 折',
    ...
    'zh-TW': {
      ...
      nav:['主頁','控制台','模型廣場','排行榜','文件','群聊','邀請返現'],pill:'全球模型直連 · 低至 1 折',
    ...
    en: {
      ...
      nav:['Home','Console','Model Square','Rankings','Docs','Group Chat','Referral rewards'],pill:'Global model access · From 0.1×',titleFrames:[[{text:'One gateway for',grad:'gateway'},{text:'every AI Agent'}],[{text:'Production-ready',grad:'Production'},{text:'unified LLM gateway'}]],heroButtons:['Get API Key','Download client'],protocol:['OpenAI protocol','Anthropic protocol','Google protocol'],routeHero:['GLOBAL MODEL ACCESS','AGENT CLIENTS','Smart routing','Supports 10+ Agents / clients'],
    ...
    ja: {
      ...
      nav:['ホーム','コンソール','モデル広場','ランキング','ドキュメント','グループチャット','紹介特典'],pill:'世界中のモデルへ直結 · 最低 1 割',titleFrames:[[{text:'AI Agent 接続の',grad:'AI Agent'},{text:'統合ゲートウェイ'}],[{text:'本番環境向けの',grad:'本番環境'},{text:'統合 LLM ゲートウェイ'}]],heroButtons:['API Key を取得','クライアントを入手'],protocol:['OpenAI プロトコル','Anthropic プロトコル','Google プロトコル'],routeHero:['世界中のモデルへ直結','AGENT クライアント','スマートルーティング','10+ Agent / クライアントに対応'],
